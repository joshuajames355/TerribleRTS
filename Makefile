...
UNREALROOTPATH = "/home/cybermidknight/UnrealEngine4/Install/UnrealEngine"
GAMEPROJECTFILE =/home/cybermidknight/SimpleGeometryRTS/MyProject.uproject
...
MyProject-Linux-Debug:
	 $(PROJECTBUILD) MyProject Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)
...
MyProject-Linux-Test:
	 $(PROJECTBUILD) MyProject Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

MyProject:
	 $(PROJECTBUILD) MyProject Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

MyProjectEditor-Linux-Debug:
	 $(PROJECTBUILD) MyProjectEditor Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)
...
MyProjectEditor-Linux-Test:
	 $(PROJECTBUILD) MyProjectEditor Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)
